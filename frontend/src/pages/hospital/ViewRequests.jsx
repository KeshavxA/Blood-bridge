              ...
              <tr>
                <td colSpan="6" className="px-6 py-12 text-center text-gray-500 bg-gray-50">
                  <div className="flex flex-col items-center justify-center gap-3">
                    ...
                    <p className="text-sm text-gray-500 max-w-sm">When receivers request blood samples from your hospital, they will appear here for you to approve or reject.</p>
                  </div>
                </td>
              </tr>
            ) : (
